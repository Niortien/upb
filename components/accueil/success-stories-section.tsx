  ...
  const stories = [
    {
      ...
      achievement:
        "Felicité d&apos;Honneur de la République de Côte d&apos;Ivoire",
      description:
        "Diplômée de notre programme de doctorat en 2015, Marie a révolutionné la recherche sur l'énergie quantique. Son travail a été reconnu mondialement par le Prix Nobel.",
      image:
    ...
    },
    {
      ...
      achievement:
        "Felicité d&apos;Honneur par les autorités de la commune de Bingerville",
      description:
        "Après son Master en IA, Thomas a créé une startup valorisée à 2 milliards d'euros. Son entreprise développe des solutions d'IA pour la santé publique",
    ...
    },
    {
      ...
      description:
        "Diplômée en Relations Internationales, Fatima œuvre pour l'éducation dans 50 pays. Elle a lancé des programmes touchant 5 millions d'enfants.",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-block px-4 py-2 bg-secondary/10 rounded-full mb-4">
            <span className="text-sm font-semibold text-secondary uppercase tracking-wider font-protos">
          ...
          <p className="text-lg  font-raleway text-muted-foreground leading-relaxed">
            Des parcours exceptionnels qui illustrent l&apos;excellence de notre
            formation et l&apos;impact de nos diplômés sur la société.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex flex-col items-center gap-4 p-10 bg-gradient-to-br from-primary via-primary to-primary/80 rounded-3xl shadow-2xl">
            ...
            <p className="text-lg text-white/90 max-w-2xl">
              Rejoignez une communauté d&apos;excellence et tracez votre propre
