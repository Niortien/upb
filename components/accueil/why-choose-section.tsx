...
const reasons = [
  {
    ...
    description: "ClassÃ©e parmi les 50 meilleures universitÃ©s de CÃ´te d'Ivoire",
    stat: "Top 10",
  ...
  },
  {
    ...
    description: "Plus de 10 clubs actifs couvrant divers intÃ©rÃªts professionnels",
    stat: "10+ Clubs",
  ...
  },
  {
    ...
    description: "AccÃ¨s Ã©quitable Ã  la technologie + Wi-Fi haut dÃ©bit sur tout le campus",
    stat: "100%",
  ...
  },
  {
    icon: TrendingUp,
    title: "EmployabilitÃ©",
    description: "65% de nos diplÃ´mÃ©s trouvent un emploi dans les 6 premiers mois",
    stat: "65%",
  ...
  },
  {
    ...
    description: "Des partenariats avec des entreprises et institutions Ã  travers l'Afrique",
    stat: "5+ Pays",
  ...
  },
  {
    ...
    description: "SystÃ¨me de parrainage pour un suivi personnalisÃ© tout au long du cursus",
    stat: "1:15",
...
const globalStats = [
  { value: "7+", label: "AnnÃ©es d'Excellence" },
  { value: "5 000+", label: "Ã‰tudiants Actifs" },
  { value: "15+", label: "Professeurs Experts" },
  { value: "5+", label: "Pays ReprÃ©sentÃ©s" },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-4xl sm:text-5xl font-protos font-black text-foreground mb-6 leading-tight">
            Une universitÃ© qui{" "}
            <span className="text-gradient-primary">fait la diffÃ©rence</span>
          </h2>
          <p className="text-lg text-muted-foreground font-raleway leading-relaxed">
            DÃ©couvrez ce qui rend notre universitÃ© unique et pourquoi des
            milliers d&apos;Ã©tudiants nous font confiance chaque annÃ©e.
          </p>
        </div>

        {/* Bento grid layout */}
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {/* Large featured card â€” image */}
          <div className="lg:col-span-1 lg:row-span-2 relative rounded-3xl overflow-hidden shadow-2xl group min-h-[500px]">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              ...
              <h3 className="text-2xl font-protos font-bold text-white leading-tight">
                Un environnement d&apos;Ã©tude conÃ§u pour l&apos;excellence
              </h3>
              <p className="text-white/70 text-sm mt-2 font-raleway">
                Infrastructures modernes, espaces collaboratifs et bibliothÃ¨que numÃ©rique
              </p>
            </div>
          </div>
